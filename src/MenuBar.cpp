        ...
        QMenuBar(parent)
{
        ...
        m_actions.editReplace = editMenu->addAction(tr("Replace..."));
        m_actions.editReplace->setShortcut(QKeySequence("Ctrl+H"));
        editMenu->addSeparator();
        ...
        m_actions.helpAbout = helpMenu->addAction(tr("About %1...").arg(QCoreApplication::applicationName()), this, SLOT(aboutQt()));
